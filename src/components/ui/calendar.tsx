...
function Calendar({
  ...
  const _selectedClassName = cn(
    "[&>button]:bg-[#FF5F00] [&>button]:text-primary-foreground [&>button]:hover:bg-[#FF5F00] [&>button]:hover:text-primary-foreground [&>button]:font-semibold",
  ...
  return (
    <DayPicker
      ...
      hideNavigation={false} // Ensure navigation is hidden
